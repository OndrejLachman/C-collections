...
namespace Kolekce
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Llist.AddFirst("Nový první"); //přesune původní první na druhou pozici
            Llist.AddLast("Nový poslední"); //nový poslední prvek, předchozí poslední prvek je před tímto prvkem
